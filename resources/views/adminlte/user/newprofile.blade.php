                  ...
                  <ul class="chart-legend clearfix">
                    <li>
                    	...
                    	<a href="{{ route('driver_details', encrypt($pie_chart_data[0]['driver_id'])) }}">
                    	 {{ $pie_chart_data[0]['label'] }} : {{ $pie_chart_data[0]['value'] }} Deliveries </a>
                    </li>
                    <li>
                    	<i class="fa fa-circle-o text-green"></i>
                    	<a href="{{ route('driver_details', encrypt($pie_chart_data[1]['driver_id'])) }}">
                    	 {{ $pie_chart_data[1]['label'] }} : {{ $pie_chart_data[1]['value'] }} Deliveries </a>
                    </li>
                    <li><i class="fa fa-circle-o text-yellow"></i>
                    	<a href="{{ route('driver_details', encrypt($pie_chart_data[2]['driver_id'])) }}">
                    	 {{ $pie_chart_data[2]['label'] }} : {{ $pie_chart_data[2]['value'] }} Deliveries </a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              firstChild.addEventListener('click', function() {
                  ...
                  if(navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(function(position) {
                        ...
                        new_infowindow.setContent('Your current location');
                        new_infowindow.open(map, myMarker);
