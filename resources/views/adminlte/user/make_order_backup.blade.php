        ...
        <div class="col-lg-4 d-lg-flex flex-lg-column align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          ...
          <div class="wrap-contact100">
            <form action="{{ route('make_order_post') }}" method="POST" id="bidding_form" data-parsley-validate="">
              {{ csrf_field() }}
              <div class="wrap-input100 validate-input" data-validate="Pickup Location is required">
                <label for="exampleTextarea">Pickup Location:</label>
                <input class="input100" type="text" id="pickup_autocomplete" name="pickup_address" placeholder="Pickup Location" value="{{ auth()->user()->restaurant_location }}" required="">
              ...
              <div class="wrap-input100 validate-input" data-validate="Dropoff Location is required">
                <label for="exampleTextarea">Dropoff Location:</label>
                <input class="input100" type="text" id="dropoff_autocomplete" name="dropoff_address" placeholder="Dropoff Location"  required="" onfocus="initAutocomplete2()">
              ...
              <!-- <div class="wrap-input100 validate-input" >
                <input class="input100" type="text" name="mini_distance_charges" value="Min Distance Charges: SAR {{ $setting->mini_distance_charges }}" placeholder="Min Distance">
                <span class="focus-input100"></span>
              </div> -->

              <div class="wrap-input100 validate-input" >
                <label for="exampleTextarea">Total Distance:</label>
                <input class="input100" type="text" name="total_distance" placeholder="Total Distance" readonly="" id="total_distance">

                <input type="hidden" name="total_distance_value" value="">
              </div>

              <div class="wrap-input100 validate-input" data-validate="Name is required">
                <label for="exampleTextarea">Customer Name:</label>
                <input class="input100" type="text" name="customer_name"  required="" placeholder="Customer Name">
                <span class="focus-input100"></span>
              </div>
              <div class="wrap-input100 validate-input">
                <label for="exampleTextarea">Customer Number:</label>
                <input class="input100" type="text" name="customer_number"  data-parsley-type="digits" required="" placeholder="Customer number">
                <span class="focus-input100"></span>
              </div>

              <div class="wrap-input100 validate-input" >
                <label for="exampleTextarea">Order Amount:</label>
                <input class="input100" type="text" name="order_amount"  required="" id="order_amount" placeholder="Order Amount" min="1" data-parsley-type="number" onchange="setGrandTotal()">
                <span class="focus-input100"></span>
              </div>

              <div class="wrap-input100 validate-input" >
                <label for="exampleTextarea">Delivery Fee:</label>
                <input class="input100" type="text" name="delivery_fee" placeholder="Delivery Fee" readonly="" id="delivery_fee">
              </div>

              <div class="wrap-input100 validate-input" >
                <label for="exampleTextarea">Grand Total:</label>
                <input class="input100" type="text" name="grand_total" placeholder="Grand Total" readonly="" id="grand_total">
              </div>

              <div class="validate-input">
                <label for="exampleTextarea">Order Description:</label>
                <textarea class="form-control input100"  required="" name="order_description" id="exampleTextarea" rows="3" placeholder="Sandwhich Shah"></textarea>
              </div>

              <div class="validate-input">
                <label for="exampleTextarea">Address:</label>
                <textarea class="form-control input100"  required="" name="address" id="exampleTextarea" rows="3" placeholder="H # 4, Floor # 1"></textarea>
              </div>

              <div class="container-contact100-form-btn">

                <input type="submit" value="Submit" class="btn btn-success" id="submit_btn" style="display: block; line-height: 30px; width: 100%; margin-bottom: 10px;">
            ...
            function(response, status) { // anonymous function to capture directions
              if (status !== 'OK') {
                ...
                if (!directionsData) {
                  ...
                  var mini_distance_charges = {{ $setting->mini_distance_charges }};
                  var mini_distance = {{ $setting->mini_distance }};
                  var charges_per_km = {{ $setting->charges_per_km }};
